...
TEST(expected, valid_value)
{
    ...
    out(std::expected<std::vector<int>, std::string>{std::vector{1,2,3,4}}).or_throw();
    ...
    std::expected<std::vector<int>, std::string> e = std::unexpected(std::string("error"));
    in(e).or_throw();
...
{
    auto [data, in, out] = zpp::bits::data_in_out();
    const std::expected<std::vector<int>, std::string> e{std::vector<int>{1,2,3,4}};
    out(e).or_throw();
    ...
    std::expected<std::vector<int>, std::string> exp = std::unexpected(std::string("error"));
    in(exp).or_throw();
...
{
    auto [data, in, out] = zpp::bits::data_in_out();
    out(std::expected<std::vector<int>, std::string>{std::unexpected("test error")}).or_throw();
...
{
    auto [data, in, out] = zpp::bits::data_in_out();
    out(std::expected<void, std::string>{std::unexpected("void error")}).or_throw();
